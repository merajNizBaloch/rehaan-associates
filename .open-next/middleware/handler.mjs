    ...
    try {
      ...
      switch (cachedData?.value?.type) {
        ...
        case "route": {
          ...
          const statusCode = event.rewriteStatusCode ?? cachedData.value.meta?.status ?? 200;
          const headers = {
            ...cacheControl,
            ...cachedData.value.meta?.headers,
            vary: VARY_HEADER
